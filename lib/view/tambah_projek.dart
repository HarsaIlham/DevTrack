...
class _TambahProjekState extends State<TambahProjek> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (pickedFile != null) {
        ...
        // Set foto path ke controller (atau bisa diupload ke server dulu)
        _projectController.fotoController.text = pickedFile.path;
      }
    } catch (e) {
  ...
  void _onSubmit() async {
    if (_formKey.currentState!.validate()) {
      if (selectedLocation == null) {
        _showSnackBar('Silakan pilih lokasi terlebih dahulu');
        return;
      }
      ...
      if (_projectController.isSuccess) {
        _showSnackBar('Proyek berhasil ditambahkan!');
          ...
          child: AbsorbPointer(
            child: TextFormField(
              ...
              controller: TextEditingController(
                text: controller.selectedDeadline == null
                    ? ''
  ...
  Widget _buildStatusDropdown() {
    return DropdownButtonFormField<String>(
      value: _projectController.statusController.text.isNotEmpty
          ? _projectController.statusController.text
          : null,
      items: ['Belum Mulai', 'Sedang Berjalan', 'Selesai']
          .map(
                          ...
                          child: Container(
                            ...
                            child: IconButton(
                              onPressed: () {
                                setState(() {
                                  _image = null;
                                  _projectController.fotoController.clear();
                                });
                              },
                              icon: const Icon(
                                Icons.close,
